    ...
    <section id="contact" className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 border-t border-border">
      <div className="max-w-3xl mx-auto text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="mailto:dk.sharma@wassup.co.in"
        ...
        <div className="flex justify-center gap-6 pt-8">
          <a href="https://github.com/sharma-IND" className="text-muted-foreground hover:text-accent transition" title="GitHub">
          ...
          <a href="#" className="text-muted-foreground hover:text-accent transition" title="LinkedIn">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="#" className="text-muted-foreground hover:text-accent transition" title="Twitter">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
